...
files <- c("/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570735.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570736.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570737.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570738.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570739.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570740.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570741.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570742.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570743.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570744.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570745.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570746.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570747.ReadsPerGene.out.tab",
           "/Users/xlu/Documents/Bioinformatics/Kim_RNAseq/Outputs/star_countmatrix/SRR14570748.ReadsPerGene.out.tab")
...
samplenames <- substring(colnames(all_counts), 73, 83) 
samplenames

colnames(all_counts) <- samplenames
group <- as.factor(c("Brg1_SA_KCl", "Brg1_SA", "Brg1_SA_KCl", "Brg1_SA",
                     "Brg1_SE_KCl", "Brg1_SE", "Brg1_SE_KCl", "Brg1_SE",
                     "WT_KCl_SA", "WT_SA", "WT_KCl_SA", "WT_SA",
                     "WT_KCl_SE", "WT_SE"))
all_counts$samples$group <- group
all_counts$samples

sample_treatment <- as.factor(c("SRR14570735_Brg1_SA_KCl","SRR14570736_Brg1_SA","SRR14570737_Brg1_SA_KCl","SRR14570738_Brg1_SA",
                                "SRR14570739_Brg1_SE_KCl","SRR14570740_Brg1_SE","SRR14570741_Brg1_SE_KCl","SRR14570742_Brg1_SE",
                                "SRR14570743_WT_KCl_SA", "SRR14570744_WT_SA", "SRR14570745_WT_KCl_SA", "SRR14570746_WT_SA",
                                "SRR14570747_WT_KCl_SE", "SRR14570748_WT_SE"))
...
cpm <- cpm(all_counts)
keep <- rowSums(cpm(all_counts)>0.5)>=2
...
# 0.9954645 1.0079685 1.0353488 1.0324011 0.9051036 0.9743789 0.9312706 
# 0.9548661 1.1045263 1.1255336 1.0153583 1.0433733 0.9369616 0.9634569
...
glMDSPlot(lcpm, labels=paste(sample_treatment, sep="_"), 
          ...
          launch=TRUE)
# file:///Users/xlu/Documents/Bioinformatics/Kim_RNAseq/glimma-plots/MDS-Plot.html
...
contr.matrix <- makeContrasts(
  WT_SA.vs.WT_KCl_SA = WT_KCl_SA - WT_SA, 
  WT_SE.vs.WT_KCl_SE = WT_KCl_SE - WT_SE, 
  Brg1_SA_KCl.vs.Brg1_SA = Brg1_SA_KCl - Brg1_SA,
  Brg1_SE_KCl.vs.Brg1_SE = Brg1_SE_KCl - Brg1_SE,
  Brg1_SA.vs.WT_SA = Brg1_SA - WT_SA,
  Brg1_SE.vs.WT_SE = Brg1_SE - WT_SE,
  Brg1_SA_KCl.vs.WT_KCl_SA = Brg1_SA_KCl - WT_KCl_SA,
  Brg1_SE_KCl.vs.WT_KCl_SE = Brg1_SE_KCl - WT_KCl_SE,
...
sum <- summary(dt)
write.csv(sum,"Differential_Expression_Summary.csv")
...
for(i in 1:length(comparisons)){
  ...
  tmp$direction[which(tmp$logFC > 1)] = c("Increase")
  tmp$direction[which(tmp$logFC < -1)] = c("Decrease")
  ...
  #add lines
  abline(h = -log10(0.05), col = c("black"), lty = 2, lwd = 1)
...
WT_SA.vs.WT_KCl_SA<- topTreat(tfit, coef=1, n=Inf)
head(WT_SA.vs.WT_KCl_SA)
